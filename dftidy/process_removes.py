...
# Prompt: dftidy_remove.txt  Version: 1.0
...
def _validate_df_config(df_config: Dict[str, Any]) -> None:
    ...
    Args:
        df_config: Configuration dictionary for DataFrame tidying.
...
def _drop_columns(
    ...
    df_tidy = df.drop(columns=existing_columns, errors="ignore")
    return df_tidy
...
def process_removes(
    ...
    df_tidy = _drop_columns(df=df, columns_to_remove=columns_to_remove, inplace=inplace)
    return df_tidy
